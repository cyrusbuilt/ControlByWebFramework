...
namespace CyrusBuilt.ControlByWeb.WebSwitch
{
    ...
    /// </summary>
    public class WebSwitchController : IDisposable
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CyrusBuilt.ControlByWeb.WebSwitch.WebSwitchController"/> 
        /// class. This is the default constructor.
        /// </summary>
        public WebSwitchController() {
        }
        ...
        /// </param>
        public WebSwitchController(IPAddress ipAddr) {
            this._ip = ipAddr;
        }
        ...
        /// </exception>
        public WebSwitchController(IPAddress ipAddr, Int32 port) {
        ...
        /// </param>
        public WebSwitchController(IPEndPoint endpoint) {
            if (endpoint != null) {
        ...
        /// </exception>
        private WebSwitchState GetStateFromXmlNode(XmlNode node) {
            if (node == null) {
                throw new ArgumentNullException("node");
            }

            WebSwitchState state = new WebSwitchState();
        ...
        /// <paramref name="node"/> cannot be null.
        /// </exception>
        private WebSwitchDiagnostics GetDiagsFromXmlNode(XmlNode node) {
            if (node == null) {
                throw new ArgumentNullException("node");
            }

            WebSwitchDiagnostics diags = new WebSwitchDiagnostics();
            String itemText = String.Empty;
            Int32 value = 0;
        ...
        /// that is not understood by this method.
        /// </exception>
        public WebSwitchState GetState() {
        ...
        /// </summary>
        /// <returns>
        /// If successful, a <see cref="WebSwitchDiagnostics"/> state object
        ...
        /// that is not understood by this method.
        /// </exception>
        public WebSwitchDiagnostics GetDiagnostics() {
        ...
        /// that is not understood by this method.
        /// </exception>
        public void SetState(WebSwitchState state) {
            if (state == null) {
            ...
            WebSwitchState currentState = new WebSwitchState();
        ...
        public void ResetState() {
            WebSwitchState state = this.GetState();
            if (state == null) {
                return;
            }
            state.Reset();
