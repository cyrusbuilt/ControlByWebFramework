...
namespace CyrusBuilt.ControlByWeb.Daq.X301Module
{
	...
	/// </summary>
	public class X301Event : EventBase
	{
		#region Fields
		private X301Action _action = X301Action.None;
		#endregion
		
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="CyrusBuilt.ControlByWeb.Daq.X301Module.X301Event"/> class.
		...
		/// </param>
		public void SetOrOverrideAction(X301Action action) {
			this._action = action;
		}
		...
		public override Boolean Equals(Object obj) {
			...
			X301Event evt = obj as X301Event;
			if ((X301Event)evt == null) {
				return false;
			}
		...
		/// otherwise, false.
		/// </returns>
		public Boolean Equals(X301Event evt) {
