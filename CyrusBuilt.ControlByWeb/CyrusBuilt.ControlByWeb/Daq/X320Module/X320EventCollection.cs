...
namespace CyrusBuilt.ControlByWeb.Daq.X320Module
{
    ...
    /// </summary>
    public sealed class X320EventCollection : CollectionBase
    {
        #region Constructors
        /// <summary>
        ...
        #region Properties
        /// <summary>
        /// Gets or sets the <see cref="X320Event"/> at the specified index.
        /// </summary>
        /// <param name="index">
        /// The zero-based index of the <see cref="X320Event"/> to get or set.
        /// </param>
        /// <returns>
        /// The <see cref="X320Event"/> at the specified index.
        /// </returns>
        public X320Event this[Int32 index] {
            get { return (X320Event)base.List[index]; }
        ...
        #region Methods
        /// <summary>
        /// Adds an <see cref="X320Event"/> to the collection.
        /// </summary>
        /// <param name="evt">
        /// The <see cref="X320Event"/> to add.
        /// </param>
        /// <returns>
        /// The position into which the new <see cref="X320Event"/> was
        /// inserted.
        /// </returns>
        ...
        /// collection.
        /// </exception>
        public Int32 Add(X320Event evt) {
            return base.List.Add(evt);
        }

        /// <summary>
        /// Inserts a new <see cref="X320Event"/> into the collection at the
        /// specified index.
        /// </summary>
        /// <param name="index">
        /// The zero-based index at which the <see cref="X320Event"/> should be
        /// inserted.
        /// </param>
        /// <param name="evt">
        /// The <see cref="X320Event"/> to insert into the collection.
        /// </param>
        ...
        /// </exception>
        public void Insert(Int32 index, X320Event evt) {
            base.List.Insert(index, evt);
        }

        /// <summary>
        /// Removes the first occurrence of a specified <see cref="X320Event"/>
        /// from the collection.
        /// </summary>
        /// <param name="evt">
        /// The <see cref="X320Event"/> to remove from the collection.
        /// </param>
        public void Remove(X320Event evt) {
        ...
        /// </summary>
        /// <param name="evt">
        /// The <see cref="X320Event"/> to locate in the collection.
        /// </param>
        /// <returns>
        /// <b>true</b> if the <see cref="X320Event"/> is found in the
        /// collection; Otherwise, <b>false</b>.
        /// </returns>
        public Boolean Contains(X320Event evt) {
            return base.List.Contains(evt);
        }

        /// <summary>
        /// Determines the index of a specific <see cref="X320Event"/> in the
        /// collection.
        /// </summary>
        /// <param name="evt">
        /// The <see cref="X320Event"/> to locate in the collection.
        /// </param>
        /// <returns>
        /// The index of the <see cref="X320Event"/> if found in the collection;
        /// Otherwise, -1.
        /// </returns>
        public Int32 IndexOf(X320Event evt) {
            return base.List.IndexOf(evt);
        }

        /// <summary>
        /// Copies the elements of the collection to a <see cref="X320Event"/>
        /// array, starting at a particular array index.
        /// </summary>
        /// <param name="array">
        /// The one-dimensional <see cref="X320Event"/> array that is the
        /// destination of the elements copied from the collection.  The
        /// <see cref="X320Event"/> array must have zero-based indexing.
        /// </param>
        /// <param name="index">
        ...
        /// </exception>
        public void CopyTo(X320Event[] array, Int32 index) {
        ...
        /// <b>false</b>.
        /// </returns>
        public static Boolean IsNullOrEmpty(X320EventCollection events) {
        ...
        /// <summary>
        /// Gets an <see cref="X320Event"/> from the collection by ID.
        /// </summary>
        /// <param name="id">
        /// The ID of the event to locate.
        /// </param>
        /// <returns>
        /// If successful, the <see cref="X320Event"/> with the matching ID;
        /// Otherwise, null.
        /// </returns>
        public X320Event GetEventById(Int32 id) {
            X320Event evt = null;
            foreach (X320Event thisEvent in this) {
                if (thisEvent.Id == id) {
                    evt = thisEvent;
                    break;
                }
        ...
        /// </param>
        public void Replace(X320Event current, X320Event replacement) {
